...
class App extends React.Component {
  ...
  render() {
    if (this.state.ready === true) {
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("body", null, /* @__PURE__ */ React.createElement("h1", null, "Gompei Clicker"), /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("h2", null, "Loading...")));
    }
  }
  addToScore(e) {
  ...
  buyTextbook(e) {
    if (this.state.score >= this.state.textbookCost) {
      ...
      this.setState({
        textbookCost: Math.round(this.state.textbookCost * 2)
      });
  ...
  buyMeditate(e) {
    if (this.state.score >= this.state.meditateCost) {
      ...
      this.setState({
        meditateCost: Math.round(this.state.meditateCost * 5)
      });
