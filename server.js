...
app.get("/meme_maker", function(request, response)
{
  response.sendFile(__dirname + "/views/meme_maker.html")
})
...
db.defaults(
{
  "users":
  [
    {"username": "raccoon", "password": "memes"},
  ],
  "chats":
  [
    {"username": "raccoon", "contents": "Welcome to the chatroom!" , "time": new Date(), "uuid": uuid()},
  ],
